...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'composite' | 'kiro'
...
export type RedeemUsagePolicy = 'single_use' | 'once_per_user'
