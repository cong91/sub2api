...
const paymentCurrencyOptions = computed(() => PAYMENT_CURRENCY_OPTIONS.map(option => ({
  value: option.value,
  label: option.value === 'VND' ? '₫ VND' : option.value === 'KRW' ? '₩ KRW' : option.value === 'CNY' ? '¥ CNY' : option.label,
})))
