...
import { PAYMENT_MODE_QRCODE, PAYMENT_MODE_POPUP, PAYMENT_MODE_MANUAL } from './providerConfig'
...
const modeLabel = computed(() => {
  ...
  if (props.provider.payment_mode === PAYMENT_MODE_MANUAL) return t('admin.settings.payment.modeManual')
  return ''
})
