<template>
  <div class="card p-6">
    <div class="flex flex-col items-center gap-4 py-6 text-center">
      ...
      <div v-if="errorMessage" class="w-full rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-700 dark:border-red-800/50 dark:bg-red-900/20 dark:text-red-300">
        {{ errorMessage }}
      </div>
