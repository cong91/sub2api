<template>
  ...
  >
    ...
    >
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity' && form.platform !== 'kiro'" class="space-y-4">
        <div v-if="!isCNPlatform || apiProtocol !== 'adaptive'">
          ...
          <input
            ...
            type="text"
            class="input"
            :placeholder="isCNPlatform ? apiKeyBaseUrlPlaceholder : apiKeyCompatibleBaseUrl(form.platform)"
          />
      ...
      <!-- OpenAI long-context token billing -->
      <div
...
watch(
  ...
  (newPlatform) => {
    ...
    if (newPlatform === 'kimi' || newPlatform === 'zhipu' || newPlatform === 'deepseek') {
      ...
      apiKeyBaseUrl.value = newPlatform === 'grok'
        ? 'https://api.x.ai/v1'
        : apiKeyCompatibleBaseUrl(newPlatform)
    }
