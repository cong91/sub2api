export default {
    accounts: {
      ...
      openaiProvision: {
        statusTitle: 'OpenAI replenishment status',
        loading: 'Loading OpenAI status...',
        healthySummary: 'Healthy OpenAI: {healthy}/{target}',
        checkingSummary: 'Checking OpenAI accounts...',
        provisioningSummary: 'Creating accounts: {count} awaiting callback',
        reauthorizationSummary: 'Reauthorizing accounts: {count}',
        healthy: 'Healthy OAuth',
        pending: 'Provisioning pending',
        requested: 'Last requested',
        reauthorization: 'Reauth pending',
        lastCallback: 'Last callback',
        nextCheck: 'Next check',
        lastCheck: 'Last check',
        reset: 'Reset pending request',
        resetting: 'Resetting...',
        resetSuccess: 'Provisioning status reset',
        resetFailed: 'Failed to reset provisioning status',
        notAvailable: 'Not available',
        noCallback: 'No callback received',
        received: 'Received',
        phase: {
          disabled: 'Disabled',
          idle: 'Waiting for next cycle',
          checking: 'Checking account count',
          sending_provision_request: 'Sending account creation request',
          waiting_for_provision_callback: 'Waiting for provisioning callback',
          waiting_for_reauthorization_callback: 'Waiting for reauthorization callback',
