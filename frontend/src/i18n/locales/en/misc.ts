export default {
  ...
  payment: {
    ...
    fxRateMissing: 'Missing exchange rate for {currencies}',
    fxRateStale: 'Exchange rate from {source} may be stale',
    fxRateUpdated: 'Exchange rate from {source}, updated {time}',
