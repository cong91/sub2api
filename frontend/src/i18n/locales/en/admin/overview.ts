export default {
    ...
    users: {
      ...
      identityCodeUser: 'Device identity user',
      copyIdentityCode: 'Copy device identity code',
      identityCodeCopied: 'Device identity code copied',
      failedToCopyIdentityCode: 'Failed to copy device identity code',
