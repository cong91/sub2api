export default {
    accounts: {
      ...
      dataImportProxyNoneDesc: 'Do not bind imported accounts to any proxy.',
      dataImportProxyRandomLive: 'Random active proxy',
      dataImportProxyRandomLiveDesc: 'Assign each imported account to a currently active proxy at random.',
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionAuth: 'Codex OAuth auth.json / access-token batch import',
          ...
          codexSessionHint: 'sessionToken is not saved as refresh_token. Without refresh_token, the account expires with the accessToken expiry; import is rejected if the expiry cannot be parsed and step 1 has no expiration.',
          codexSessionImportAndCreate: 'Import & Create Account',
          codexSessionEmpty: 'Please enter a Codex OAuth auth.json or accessToken',
