export default {
    settings: {
      ...
      dataset: {
        ...
        description: 'Capture bounded, asynchronous request/response records for fine-tuning exports.',
        enabled: 'Enable dataset collection',
        enabledHint: 'Capture remains fail-open and asynchronous; disabling stops new collection without changing gateway behavior.',
        credentials: 'Google Drive OAuth credentials',
        credentialsConfigured: 'Credentials configured',
        credentialsMissing: 'Credentials not configured',
        credentialsHint: 'Select the OAuth client JSON file. The file is sent only when selected, encrypted before storage, and never returned to the browser.',
        selectedFile: 'Selected: {fileName}',
        folderId: 'Google Drive folder ID',
        folderIdPlaceholder: '1AbCdEfGhIjKlMnOpQrStUvWxYz',
        folderIdHint: 'Use the destination folder ID from the Google Drive URL.',
        batchSize: 'Maximum records per batch',
        batchSizeHint: 'Flush a batch when this many records are ready. Range: 1–1000.',
        batchMaxMB: 'Maximum batch size (MB)',
        batchMaxMBHint: 'Flush before the JSONL payload exceeds this size. Range: 1–100 MB.',
        batchIntervalSec: 'Batch interval (seconds)',
        batchIntervalHint: 'Flush an open batch after this interval. Range: 1–3600 seconds.',
        bufferMaxItems: 'Maximum buffered records',
        bufferMaxItemsHint: 'Bounded in-memory queue capacity; records are dropped rather than blocking gateway traffic.',
        writeOnlyNotice: 'Credentials are write-only. Existing client secrets and refresh tokens are never loaded into this form or returned by the API.',
        fileTooLarge: 'Credential file must be smaller than {maxKb} KiB.',
        fileEmpty: 'Credential file is empty.',
        fileReadFailed: 'Unable to read the credential file.',
      },
      testEmail: {
      ...
      telegramNotifications: {
        ...
        description: 'Send real-time notifications to a Telegram group or channel through the Bot API',
        botToken: 'Bot Token',
        botTokenPlaceholder: '123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11',
        botTokenHint: "Create a bot through {'@'}BotFather to get the token",
        botTokenConfiguredPlaceholder: '********',
        botTokenConfiguredHint: 'A token is configured. Leave empty to keep the current value.',
        chatId: 'Chat ID',
        chatIdPlaceholder: '-1001234567890',
        chatIdHint: "Group or channel Chat ID. Use {'@'}userinfobot to find it.",
        testConnection: 'Test Connection',
        testing: 'Testing...',
        ...
        notifyAccountExpiredHint: 'Send a notification when an account is suspended because it expired',
        notifyPaymentSuccess: 'Payment Succeeded',
        notifyPaymentSuccessHint: 'Send a notification when a payment completes',
        ...
        notifySubExpiredHint: 'Send a notification when a subscription expires',
        notifyBalanceLow: 'Low Balance',
        notifyBalanceLowHint: 'Send a notification when a user balance is low',
        notifyOpsAlert: 'Operations Alerts',
        notifyOpsAlertHint: 'Send a notification when an operations alert is raised',
