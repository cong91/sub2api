export default {
	...
	keys: {
		...
		selectGroup: "选择分组",
		selectDefaultGroup: "选择默认分组",
		defaultGroupHint: "默认分组仅作为歧义请求的兜底偏好，并用于快速配置。",
		accessGroupsLabel: "可访问分组",
		accessGroupsHint:
			"运行时会根据模型/平台/账号可调度性在这些分组中动态路由；请保留一个默认兜底分组。",
		statusLabel: "状态",
		selectStatus: "选择状态",
		saving: "保存中...",
		noKeysYet: "暂无 API 密钥",
		...
		clickToChangeDefaultGroup: "点击更换默认兜底分组",
		defaultGroupUpdatedSuccess: "默认分组更新成功",
		failedToUpdateDefaultGroup: "更新默认分组失败",
		groupRequired: "请选择分组",
		usage: "用量",
		today: "今日",
		total: "近30天",
	...
	profile: {
		...
		updateFailed: "资料更新失败",
		bootstrapAccessTitle: "引导访问配置",
		bootstrapAccessDescription:
			"以下 Provider/分组默认值来自邀请码引导流程，将作为创建 API 密钥时的建议默认值。",
		bootstrapDefaultProvider: "默认 Provider",
		bootstrapDefaultGroup: "默认分组 #{id}",
