  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        providerPaymentCurrenciesExample: '例如：Stripe/Paddle 通常使用 USD；支付宝/微信支付使用 CNY；仅在网关账户确实支持时才开启更多币种。',
        providerPaymentCurrenciesRequired: '请至少为此支付渠道选择一个收款币种。',
        providerCurrencyConfigured: '已配置',
        sepayProviderCurrencyHint: 'SePay 只支持 VND 充值。锁定 VND 可避免 checkout 默认选择 USD 后在网关失败。',
