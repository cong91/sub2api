export default {
	...
	keys: {
		...
		defaultGroupHint:
			"Default group is a fallback preference for ambiguous routing and quick configuration.",
		accessGroupsLabel: "Accessible Groups",
		accessGroupsHint:
			"Runtime routing derives group by model/platform/account availability across these groups. Keep a default fallback for ambiguous requests.",
		statusLabel: "Status",
		...
		clickToChangeDefaultGroup: "Click to change default fallback group",
		groupChangedSuccess: "Group changed successfully",
		defaultGroupUpdatedSuccess: "Default group updated successfully",
		failedToChangeGroup: "Failed to change group",
		failedToUpdateDefaultGroup: "Failed to update default group",
	...
	profile: {
		...
		bootstrapAccessTitle: "Bootstrap Access Setup",
		bootstrapAccessDescription:
			"These provider/group defaults were prepared during invite onboarding and are used as suggested defaults when creating API keys.",
		bootstrapDefaultProvider: "Default provider",
		bootstrapDefaultGroup: "Default group #{id}",
