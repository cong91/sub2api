...
const messages = {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies. Pick a group tag here to bind imported accounts immediately; proxy assignment is validated again by the backend so dead proxies are never assigned.',
      dataImportGroup: 'Bind to group tag',
      dataImportClearGroup: 'Clear group',
      dataImportGroupHint: 'Optional. If selected, every imported account is bound to this group immediately; no manual group_id entry is needed.',
