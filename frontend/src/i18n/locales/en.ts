export default {
  ...
  admin: {
    ...
    users: {
      ...
      redeemCode: 'redeem-code',
      inviteRedeemUser: 'Invite redeem user',
      copyRedeemCode: 'Copy redeem code',
      redeemCodeCopied: 'Redeem code copied',
      failedToCopyRedeemCode: 'Failed to copy redeem code',
