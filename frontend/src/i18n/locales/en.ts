export default {
  ...
  auth: {
    ...
    redeemCodeLabel: 'Redeem / invitation code',
    redeemCodePlaceholder: 'Enter your code',
    redeemCodeHint: 'Use a valid invite/redeem code to create and sign in to an account immediately.',
    redeemCodeRequired: 'Redeem code is required',
    redeemLoginSuccess: 'Redeem code login successful!',
    redeemLoginFailed: 'Redeem code login failed. Please check your code and try again.',
    linuxdo: {
