  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        providerPaymentCurrenciesExample: 'Example: Stripe/Paddle usually use USD; Alipay/WeChat use CNY; enable more only if the gateway account can actually collect them.',
        ...
        sepayProviderCurrencyHint: 'SePay only accepts VND top-ups. Keeping this locked to VND prevents checkout from defaulting to USD and failing at the gateway.',
