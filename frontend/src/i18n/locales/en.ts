export default {
  ...
  // Setup Wizard
  setup: {
    title: 'Token V-Claw Setup',
    description: 'Configure your Token V-Claw instance',
    database: {
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. token-v-claw-backups), choose a region',
    ...
    users: {
      ...
      adjustmentAmountHint: 'Positive numbers increase, negative numbers decrease',
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierHint: 'Defines the billing multiplier applied to requests routed through this group.',
        priorityLabel: 'Priority',
        priorityHint: 'Lower values are scheduled first when multiple groups are eligible.',
        status: 'Status',
        statusLabel: 'Status',
        accountsLabel: 'Accounts',
        accountsPlaceholder: 'Select accounts to bind to this group',
        exclusive: 'Exclusive Group',
        exclusiveLabel: 'Exclusive Group',
        exclusiveHint: 'Exclusive groups stay hidden from self-service key creation and must be granted by an admin.'
      },
      ...
      exclusiveObj: {
        yes: 'Exclusive only',
        no: 'Non-exclusive only'
      },
      noGroupsYet: 'No groups yet',
      noGroups: 'No groups yet',
      noGroupsDescription: 'Create your first group to organize API keys and control routing and billing behavior.',
      ...
      subscription: {
        ...
        type: 'Billing Type',
        typeHint:
          'Standard groups charge from wallet balance, while subscription groups consume assigned quota windows instead.',
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts and proxies; group bindings still need to be reviewed manually. Make sure existing data will not conflict.',
      ...
      noAccountsDescription: 'Add your first upstream account to start routing requests through the gateway.',
      ...
      form: {
        ...
        credentialsPlaceholder: 'Enter the required credentials for this account type',
        priorityLabel: 'Priority',
        priorityHint: 'Lower values are scheduled first.',
        weightLabel: 'Weight',
        weightHint: 'Higher weight gives this account a larger share when balancing traffic.',
        statusLabel: 'Status'
      },
      claudeCode: 'Claude Code',
      ...
      oauth: {
        ...
        authCodeDesc: 'After authorization completes, Claude will show an authorization code. Copy it and paste it below.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Token V-Claw end-user login',
