...
const messages = {
  ...
  auth: {
    ...
    loginWithRedeemCode: 'Code login',
    redeemSignIn: 'Sign in with code',
    redeemSigningIn: 'Signing in with code...',
    redeemCodeLabel: 'Login code',
  ...
  redeem: {
    ...
    redeemCodePlaceholder: 'Enter code like BAL-XXXX-XXXX-XXXX',
    redeemCodeHint: 'Code format includes prefixes like BAL, SUB, INV, CON. Letter case is normalized automatically.',
    redeeming: 'Redeeming...',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      telegramChatId: 'Telegram ID for alerts',
      telegramChatIdHint: 'Optional. Enter your Telegram user/chat ID to receive low-balance bot alerts.',
      telegramChatIdPlaceholder: 'Example: 123456789',
  ...
  admin: {
    ...
    dashboard: {
      ...
      output: 'Output',
      quickActions: 'Quick Actions',
      startUsingApi: 'After you start using the API, usage history will be shown here.',
    ...
    backup: {
      ...
      actions: {
        ...
        intervalValidation: {
          maxTokensGreaterThanMin: 'Interval #{index}: max token count ({max}) must be greater than min token count ({min})',
          maxTokensPositive: 'Interval #{index}: max token count ({value}) must be greater than 0',
          minTokensNonNegative: 'Interval #{index}: min token count ({value}) cannot be negative',
          overlap: 'Intervals #{prevIndex} and #{index} overlap: previous interval upper bound ({prevMax}) is greater than current interval lower bound ({min})',
          priceNames: {
          ...
          unboundedLast: 'Interval #{index}: an unbounded interval (max token count is empty) can only be the last one',
        },
        },
      r2Guide: {
    ...
    users: {
      ...
      statusHints: {
        active: 'Account is active and can use API keys.',
        disabled: 'Account is disabled and cannot use API keys.'
      },
      ...
      form: {
        ...
        notesHint: 'This note is only visible to administrators',
        notesLabel: 'Notes',
        notesPlaceholder: 'Please enter notes (admin-only)',
        passwordLabel: 'Password',
        passwordPlaceholder: 'Please enter password (leave empty to keep unchanged)',
        roleLabel: 'Role',
      ...
      identityCodeUser: 'Device code user',
      copyIdentityCode: 'Copy device code',
      identityCodeCopied: 'Device code copied',
      failedToCopyIdentityCode: 'Failed to copy device code',
      ...
      adjustmentAmountHint: 'Positive values increase, negative values decrease',
      ...
      noUsers: 'No users',
      noUsersDescription: 'Create your first user to start using the system.',
      roleFilter: 'Role Filter',
      saving: 'Saving...',
      searchPlaceholder: 'Fuzzy search email/username/notes/API Key/redeem code...',
    ...
    groups: {
      ...
      form: {
        ...
        priorityHint: 'Smaller values indicate higher priority, used for account scheduling',
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies. Pick one or more group tags here to bind imported accounts immediately; proxy assignment is validated again by the backend so dead proxies are never assigned.',
      dataImportGroup: 'Bind to group tags',
      dataImportClearGroup: 'Clear groups',
      dataImportGroupHint: 'Optional. If selected, every imported account is bound to all selected groups immediately; no manual group_id entry is needed.',
      dataImportProxyAssignment: 'Proxy assignment',
      dataImportProxyAssignmentHint: 'Backend re-checks active proxy status on submit. random/default modes fail if no active proxy is available.',
      dataImportProxyKeepFile: 'Keep file mapping',
      dataImportProxyKeepFileDesc: 'Use proxy_key mappings from the JSON file and create/reuse those proxies as before.',
      dataImportProxyNone: 'No proxy',
      dataImportProxyNoneDesc: 'Import accounts without assigning any proxy.',
      dataImportProxyRandomLive: 'Random active proxy',
      dataImportProxyRandomLiveDesc: 'Assign each imported account to a random proxy that is currently active.',
      dataImportProxyDefaultLive: 'Selected active proxy',
      dataImportProxyDefaultLiveDesc: 'Assign every imported account to one active proxy selected by admin.',
      dataImportDefaultProxy: 'Default active proxy',
      dataImportNoActiveProxy: 'No active proxy is available',
      dataImportSelectDefaultProxy: 'Please select an active proxy',
      ...
      accountCredit: {
        ...
        hint: 'Record prepaid credit for this upstream API key. This increases the total quota limit and lets operators track remaining upstream balance from actual burned cost.',
        amount: 'Top-up amount',
        amountPlaceholder: 'Enter USD amount',
        add: 'Add credit',
        adding: 'Adding...',
        added: 'Account credit added',
        failed: 'Failed to add account credit',
        invalidAmount: 'Credit amount must be greater than 0',
      ...
      form: {
        ...
        credentialsPlaceholder: 'Please enter Cookie or API Key',
        nameLabel: 'Account Name',
        namePlaceholder: 'Please enter account name',
        platformLabel: 'Platform',
        priorityHint: 'Smaller values indicate higher priority',
        priorityLabel: 'Priority',
    ...
    proxies: {
      ...
      columns: {
        ...
        nameLabel: 'Name',
        namePlaceholder: 'Please enter proxy name',
    ...
    ops: {
      ...
      messageTranslations: {
        apiKeyGroupDeleted: 'API key group was deleted',
        apiKeyGroupDisabled: 'API key group is disabled',
        apiKeyFiveHourQuotaExhausted: 'API key 5-hour quota exhausted',
        apiKeyDailyQuotaExhausted: 'API key daily quota exhausted',
        apiKeyWeeklyQuotaExhausted: 'API key 7-day quota exhausted',
        apiKeyQuotaExhausted: 'API key quota exhausted',
        apiKeyExpired: 'API key expired',
        dailyReport: 'Daily report',
        weeklyReport: 'Weekly report',
        errorDigest: 'Error digest',
        accountHealth: 'Account health',
        dashboardCacheReadFailed: 'Dashboard cache read failed',
        dashboardCacheRefreshFailed: 'Dashboard cache async refresh failed',
        dashboardCacheSerializeFailed: 'Dashboard cache serialization failed',
        dashboardCacheWriteFailed: 'Dashboard cache write failed',
        dashboardCacheClearFailed: 'Dashboard cache cleanup failed',
        dashboardCacheInvalidCleared: 'Dashboard cache invalid; cleared',
        aggregationWatermarkReadFailed: 'Failed to read aggregation watermark',
        aggregationJobDisabled: 'Aggregation job disabled',
        aggregationJobStarted: 'Aggregation job started',
        backfillDisabled: 'Backfill disabled',
        backfillRejected: 'Backfill rejected',
        backfillFailed: 'Backfill failed',
        recomputeFailed: 'Recompute failed',
        recomputeAbandoned: 'Recompute abandoned',
        recomputeStartFailed: 'Failed to start recompute',
        recomputeCompleted: 'Recompute completed',
        aggregationFailed: 'Aggregation failed',
        watermarkUpdateFailed: 'Watermark update failed',
        aggregationCompleted: 'Aggregation completed',
        backfillAggregationCompleted: 'Backfill aggregation completed',
        partitionCheckFailed: 'Partition check failed',
        aggregationRetentionCleanupFailed: 'Aggregation retention cleanup failed',
        usageLogRetentionCleanupFailed: 'usage_logs retention cleanup failed',
        usageDedupRetentionCleanupFailed: 'usage_billing_dedup retention cleanup failed',
        backupConfigLoadFailed: 'Failed to load scheduled backup config',
        backupConfigApplyFailed: 'Failed to apply scheduled backup config',
        backupEnabled: 'Scheduled backup enabled',
        backupDisabled: 'Scheduled backup disabled',
        backupStarted: 'Started scheduled backup',
        backupSkipped: 'Scheduled backup skipped',
        backupFailed: 'Scheduled backup failed',
        backupCompleted: 'Scheduled backup completed',
        backupCleanupFailed: 'Failed to clean expired backups',
        backupRecordSaveFailed: 'Failed to save backup record',
        restoreRecordSaveFailed: 'Failed to save restore record',
        backupAutoCleaned: 'Automatically cleaned',
        s3SecretDecryptFailed: 'S3 SecretAccessKey decrypt failed',
        openaiCodexAllowed: 'OpenAI codex_cli_only allowed official-client request',
        openaiCodexRejected: 'OpenAI codex_cli_only rejected non-official-client request',
        openaiInstructionsRequired: 'OpenAI upstream returned Instructions are required; request details were recorded for troubleshooting',
        openaiInstructionsMissing: 'OpenAI passthrough blocked locally: Codex request is missing valid instructions',
        loadCodeAssistTemporaryFailed: 'LoadCodeAssist temporary failure; keeping previous project_id',
        loadCodeAssistMissingProject: 'LoadCodeAssist failed; project_id missing, token updated, will retry on next refresh',
        logFileOutputFallback: 'Log file output initialization failed; falling back to standard output only',
        cspNonceFallback: 'Falling back to CSP without nonce',
        quotaCacheInvalidationFailed: 'quota cache invalidation failed',
        quotaLimitMayBeDelayed: 'limit may be delayed until sentinel TTL',
        quotaWindowResetMayBeDelayed: 'window reset may be delayed'
      },
      // Dashboard
    ...
    settings: {
      ...
      loginAgreementSettings: {
        title: 'Login Agreement Settings',
        description: 'Require users to review and accept the latest service terms before signing in.',
        displayMode: 'Display mode',
        modal: 'Modal',
        checkbox: 'Checkbox',
        modalHint: 'Show a blocking modal with the agreement documents before sign-in can continue.',
        checkboxHint: 'Show an agreement checkbox on the login and registration forms.',
        updatedDate: 'Updated date',
        updatedDateHint: 'Changing this date requires users to accept the latest terms again.',
        documents: 'Agreement documents',
        documentsHint: 'Configure the legal documents shown in the login agreement prompt.',
        ...
        duplicateRouteError: 'Duplicate agreement document route: {path}',
        defaultDocuments: {
      ...
      features: {
        ...
        affiliate: {
          ...
          activationPolicyTitle: 'Invite-code activation policy',
          activationPolicyHint: 'Choose which invite codes auto-activate device claims. Codes outside the list use the manual/pending flow.',
          autoActivationTitle: 'Auto approval for selected invite codes',
          autoActivationDesc: 'Devices claimed with the codes below become active immediately. Use this for tests or whitelisted campaigns.',
          manualActivationTitle: 'Manual approval for all invite codes',
          manualActivationDesc: 'No invite code auto-activates devices; users can still log in/checkout/pay, but API keys/OpenClaw wait for admin or marketing activation.',
          deviceAutoActivationCodes: 'Auto-active invite codes',
          deviceAutoActivationCodesHint: 'Enter affiliate codes separated by commas or spaces, for example AUTO_APPROVE, CN_TEST. The system uppercases and de-duplicates them on save.',
          customUsers: {
            ...
            manualBadge: 'manual',
            createAutoCode: 'Create auto-active code',
          ...
          modal: {
            ...
            autoActiveCodeLabel: 'Create an auto-active companion code',
            autoActiveCodeHint: 'When enabled, the system keeps exactly one auto-active code derived from the manual code, for example CN-4N0Q-ABCD.',
            errorBadRate: 'Please enter a number between 0 and 100',
            errorEmpty: 'Fill at least one: custom invite code, exclusive rebate rate, or auto-active companion code',
          },
          codeModal: {
            ...
            autoActiveLabel: 'Auto-active devices when claimed with this code',
            autoActiveHint: 'Leave off for normal/manual activation codes. Turn on only for codes that should activate immediately.',
            deleteTitle: 'Delete invite code',
            deleteMessage: 'Delete invite code {code}? Primary codes cannot be deleted.',
          },
          batchModal: {
      ...
      claudeCode: {
        ...
        antigravityVersionPlaceholder: 'e.g. 1.23.2',
        antigravityVersionHint:
          'Used by Antigravity upstream API requests. Leave empty to use ANTIGRAVITY_USER_AGENT_VERSION or the built-in default 1.23.2; when set, the admin setting takes precedence.'
      },
      scheduling: {
      ...
      payment: {
        ...
        modeQRCode: 'QR Code',
        modePopup: 'Popup',
        modeManual: 'Manual QR',
        field_manualQrCodeImg: 'Manual QR image',
        manualQRCodeHint: 'Upload the static QR image shown to users in manual mode. Admin confirms the order after receiving funds.',
        manualQRCodePreview: 'Manual QR preview',
        manualQRCodeImageRequired: 'Please upload an image file.',
        manualQRCodeTooLarge: 'QR image must be 1MB or smaller.',
        manualQRCodeUploading: 'Uploading QR image...',
        clearManualQRCode: 'Clear QR',
        ...
        field_bankAccountId: 'SePay bank account',
        sepayLoadBankAccounts: 'Load accounts',
        sepayBankAccountPlaceholder: 'Select bank / account number',
        sepayBankAccountHint: 'Create mode needs a SePay API Token first. Edit mode can also use the stored token. Admins choose the bank/account; the system stores the internal ID for QR generation.',
        sepayGenerateWebhookApiKey: 'Generate webhook key',
        sepayWebhookApiKeyHint: 'Generate this key in sub2api, then paste it into SePay Webhook API Key authentication. SePay will call back with Authorization: Apikey <this key>.',
        sepayWebhookTokenGenerationFailed: 'Browser crypto is unavailable; cannot generate a secure webhook key',
        sepayApiTokenRequired: 'Enter the SePay API Token before loading bank accounts',
        sepayLoadBankAccountsFailed: 'Failed to load SePay bank accounts',
        sepayNoBankAccounts: 'SePay did not return any usable bank accounts',
        sepayStoredBankAccount: 'Stored account #{id}',
        providerPaymentCurrencies: 'Accepted checkout currencies',
        providerPaymentCurrenciesHint: 'Choose what currency this provider instance can collect. Users will see only compatible currencies/methods; the system writes provider config and method capabilities automatically.',
        providerPaymentCurrenciesExample: 'Example: Stripe/Paddle usually use USD; Alipay/WeChat use CNY; choose multiple currencies only when this gateway account can really collect them.',
        providerPaymentCurrenciesRequired: 'Select at least one checkout currency for this provider.',
        providerPaymentCurrencyPlaceholder: 'Select or type currency code, e.g. USD',
        providerPaymentCurrencyCreatablePrefix: 'Use currency',
        providerPaymentCurrencyAdd: 'Add currency',
        providerCurrencyConfigured: 'Configured',
        sepayProviderCurrencyHint: 'Default SePay setup uses VND, but this list is still configurable. Add another currency only if this provider instance/gateway account really supports collecting it.',
        ...
        sepayGuideSummary: 'SePay setup needs a SePay API Token to load bank accounts; bankAccountId is selected from SePay, not typed manually.',
        sepayGuideNote: 'Docs: bank account list uses Authorization Bearer API_TOKEN from SePay API Access; webhook auth uses Authorization Apikey WEBHOOK_API_KEY generated in this form. The QR transfer message uses a friendly note plus a hidden matcher so users do not see raw order IDs.',
        sepayGuideApiTokenTitle: 'API Token / bank account discovery',
        sepayGuideApiTokenOpen: 'In SePay, create or copy the user API token with bank-account read permission.',
        sepayGuideApiTokenCall: 'The admin UI calls SePay /bankaccounts/list server-side with Authorization Bearer API_TOKEN, then renders a bank-account select box.',
        sepayGuideApiTokenFallback: 'If there is exactly one account it is auto-selected; with multiple accounts the admin chooses by bank name, account number, and account holder.',
        sepayGuideWebhookTitle: 'Webhook authentication and order matching',
        sepayGuideWebhookOpen: 'In SePay Webhooks, set the callback URL shown below, press Generate webhook key here, then paste that key into SePay API Key authentication.',
        sepayGuideWebhookCall: 'When SePay posts a transaction, the backend verifies the Webhook API Key and extracts the hidden order matcher from code/content.',
        sepayGuideWebhookFallback: 'Old visible sub2_* transfer messages remain compatible, but new QR messages hide that raw identifier from users.',
      ...
      allowUserRefund: 'Allow User Refund',
        ...
        fxStatusTitle: 'Exchange rate status',
        fxStatusHint: 'Current ledger/local currency health. This panel is separated from the form so it no longer overlaps the capability editor.',
        ...
        fxStale: 'Stale',
        fxUpdatedAt: 'Updated',
        fxMissingCurrencies: 'Missing currencies',
        fxRatesTitle: 'Exchange rates',
        fxRatesHint: 'Enter rates in the way an admin understands: how much local currency equals 1 ledger currency.',
        addFxRate: 'Add rate',
        ledgerCurrencyHint: 'The internal balance/accounting currency. Usually USD.',
        enabledPaymentCurrencies: 'Checkout currencies generated from rates',
        noPaymentCurrencies: 'No currency enabled yet',
        fxRatesGuide: 'Example: if 1 {ledger} = 26,000 VND, choose VND and type 26000 or 26.000. The system will convert it to the internal rate automatically.',
        noFxRates: 'Only the ledger currency is enabled. Add a rate to accept another payment currency.',
        fxRateCurrency: 'Payment currency',
        fxRateAmount: 'Rate users know',
        fxRateAmountHint: 'Thousands separators are accepted, e.g. 26000, 26,000, or 26.000.',
        fxRatePreview: 'System value: 1 {currency} ≈ {rate} {ledger}',
        fxRateLedgerRequired: 'Please select a valid 3-letter ledger currency.',
        fxRateCurrencyRequired: 'Please select or enter a valid 3-letter payment currency for every exchange-rate row.',
        fxRateCurrencyMustDiffer: 'Payment currency must be different from the ledger currency.',
        fxRateCurrencyDuplicate: '{currency} has more than one exchange-rate row.',
        fxRateAmountRequired: 'Please enter a positive rate for {currency}. Example: 26000 when 1 USD = 26,000 VND.',
        currencyCapabilitiesTitle: 'Supported payment currencies',
        currencyCapabilitiesHint: 'Choose the payment method/provider and the currencies it can accept. The system generates the JSON automatically.',
        currencyCapabilitiesGuide: 'Use Method for a payment method such as SePay, Provider for a gateway/provider key, and Instance for one specific provider instance. For each row, select or type currency codes like USD, CNY, VND.',
        addCurrencyCapability: 'Add capability',
        noCurrencyCapabilities: 'No custom capability configured. Checkout will use enabled currencies and gateway defaults.',
        capabilityScope: 'Apply to',
        capabilityScopeMethods: 'Method',
        capabilityScopeProviders: 'Provider',
        capabilityScopeInstances: 'Provider instance',
        capabilityTarget: 'Method / provider',
        capabilityCurrencies: 'Supported currencies',
        selectCurrency: 'Select currency',
        selectMethod: 'Select method',
        selectProviderOrProviderMethod: 'Select provider or provider/method',
        selectProviderInstance: 'Select provider instance',
        currencyRequired: 'Add at least one currency',
        capabilityTargetRequired: 'Please select or enter a payment method/provider for every currency capability row.',
        capabilityCurrencyRequired: 'Please add at least one currency for every currency capability row.',
        invalidCapabilitiesJson: 'Payment currency capabilities JSON is invalid',
        showAdvancedJson: 'Show advanced JSON',
        hideAdvancedJson: 'Hide advanced JSON',
        advancedJsonHint: 'Advanced mode is for import/export only. Normal users should use the rows above.',
      },
      balanceNotify: {
        title: 'Balance Low Notification',
      ...
      telegramNotifications: {
        ...
        description: 'Send real-time notifications to a Telegram chat via Bot API',
        botToken: 'Bot Token',
        botTokenPlaceholder: '123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11',
        botTokenHint: "Create a bot via {'@'}BotFather to get the token",
        botTokenConfiguredPlaceholder: '********',
        botTokenConfiguredHint: 'Token configured. Leave empty to keep the current value.',
        chatId: 'Chat ID',
        chatIdPlaceholder: '-1001234567890',
        chatIdHint: "Group/channel chat ID. Use {'@'}userinfobot to find it.",
        testConnection: 'Test Connection',
        testing: 'Testing...',
        testSuccess: 'Telegram test message sent successfully',
        testFailed: 'Telegram connection test failed',
        notifyNewUser: 'New User Registration',
        notifyNewUserHint: 'Send a notification when a new user registers',
        notifyAccountError: 'Account Error',
        notifyAccountErrorHint: 'Send a notification when an upstream account encounters an error',
        notifyAccountExpired: 'Account Expired',
        notifyAccountExpiredHint: 'Send a notification when accounts are auto-paused due to expiry',
        notifyPaymentSuccess: 'Payment Success',
        notifyPaymentSuccessHint: 'Send a notification when a payment is completed',
        notifyPaymentFailed: 'Payment Failed',
        notifyPaymentFailedHint: 'Send a notification when a payment fails',
        notifyRefund: 'Refund Processed',
        notifyRefundHint: 'Send a notification when a refund is requested or completed',
        notifySubExpired: 'Subscription Expired',
        notifySubExpiredHint: 'Send a notification when subscriptions expire',
        notifyBalanceLow: 'Balance Low',
        notifyBalanceLowHint: 'Send a notification when user balance is low',
        notifyOpsAlert: 'Ops Alert',
        notifyOpsAlertHint: 'Send a notification for operational alerts',
        notifyProxyExpired: 'Proxy Expiring',
        notifyProxyExpiredHint: 'Send a notification when proxies are about to expire'
      },
  ...
  announcements: {
    ...
    newCount: '{count} new announcement',
    readAt: 'Read at',
    read: 'Read',
    unread: 'Unread',
    startsAt: 'Starts at',
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: {local} = {usd}',
    fxRateMissing: 'Exchange rate is missing for: {currencies}. Please contact support before paying.',
    fxRateStale: 'Exchange rate from {source} may be outdated; the locked quote will be used at checkout.',
    fxRateUpdated: 'Exchange rate from {source}, updated at {time}.',
    ...
    paddleLoading: 'Loading Paddle checkout...',
    paddleCheckoutReady: 'Paddle checkout is ready. If it did not open automatically, click the button below.',
    paddleWaitingWebhook: 'Payment submitted. Waiting for Paddle webhook confirmation...',
    paddleLoadFailed: 'Failed to load Paddle checkout. Please refresh and try again.',
    paddleNotConfigured: 'Paddle is not configured',
    hostedCheckout: {
      provider: 'Secure payment via {provider}',
      title: 'Review your order before payment',
      orderSummary: 'Order summary',
      product: 'What you are paying for',
      amountDue: 'Amount due',
      creditedBalance: 'Balance to be credited',
      orderNo: 'Order number',
      expiresAt: 'Expires at',
      openButton: 'Open Paddle checkout',
      reopenButton: 'Reopen Paddle checkout',
      secureHint: 'Enter your card details and complete payment inside Paddle\'s secure checkout. After payment, the order will be confirmed automatically.',
      missingOrderDetails: 'Order details are incomplete. You can still open Paddle, but confirm the order number or contact support if the amount is unclear.',
      topUpProduct: 'Top up V-Claw account balance',
      subscriptionProduct: 'V-Claw service subscription',
      orderTypes: {
    ...
    admin: {
      ...
      topUsers: 'Top Users',
      noData: 'No data',
      depositOverview: 'Deposit / package grants',
      depositOverviewDesc: 'Track admin balance deposits, redeem credits, paid top-ups, and automatic/manual package grants by recipient.',
      totalDepositEvents: 'Deposit events',
      depositLedgerAmount: 'Ledger credited',
      depositCredits: 'Credits granted',
      depositPackageAssignments: 'Packages granted',
      depositAdminAutoBreakdown: 'Admin / auto',
      adminAdjustments: 'Admin deposits',
      manualAssignments: 'Manual grants',
      autoAssignments: 'Auto grants',
      depositSources: 'Deposit sources',
      depositRecipients: 'Top deposit recipients',
      ...
      depositSourceLabels: {
        paid_balance_order: 'Paid balance order',
        paid_subscription_order: 'Paid subscription order',
        redeem_balance: 'Balance redeem code',
        redeem_subscription: 'Subscription redeem code',
        redeem_affiliate_balance: 'Affiliate credit',
        admin_balance_adjustment: 'Admin balance deposit',
        manual_subscription_assignment: 'Manual package grant',
        auto_subscription_assignment: 'Automatic package grant',
      },
      days: 'days',
      weeks: 'weeks',
      months: 'months',
      ...
      balancePackagesPageTitle: 'Balance Packages',
      balancePackagesPageDesc: 'Manage top-up packages without editing JSON. Users pay the amount and receive the configured credit.',
      createBalancePackage: 'Create Package',
      editBalancePackage: 'Edit Package',
      deleteBalancePackage: 'Delete Package',
      deleteBalancePackageConfirm: 'Are you sure you want to delete this balance package?',
      packageCode: 'Package Code',
      packageLabel: 'Package Name',
      packageDescription: 'Package Description',
      packageAmounts: 'Amounts',
      amountLedger: 'Pay Amount',
      creditLedger: 'Credit Amount',
      bonusLedger: 'Bonus Credit',
      creditMultiplier: 'Credit Multiplier',
      balanceGroup: 'Balance Group',
      selectBalanceGroup: 'Select a standard balance group',
      balanceGroupHelp: 'Only active standard groups are valid. Subscription groups must be used by subscription plans, not balance top-up packages.',
      balanceGroupRequired: 'Please select a balance group',
      balanceGroupMissing: 'Missing balance group',
      payAmount: 'Pay',
      creditAmount: 'Receive',
      badge: 'Badge',
      popular: 'Popular',
      balancePackageFormula: 'Formula: user pays Pay Amount; system credits Credit Amount. Multiplier = Credit / Pay, bonus = Credit - Pay.',
      packageRequired: 'Package code and name are required',
      packageAmountRequired: 'Pay amount and credit amount must be greater than 0',
      allowUserRefund: 'Allow User Refund',
...
retryRefund: 'Retry refund',
      confirmManualPayment: 'Confirm payment',
      confirmManualPaymentPrompt: 'Confirm received funds for order {order} (amount {amount})? This will complete the order.',
      manualPaymentConfirmed: 'Manual payment confirmed',
