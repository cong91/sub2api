export default {
    settings: {
      ...
      payment: {
        ...
        sepayWebhookApiKeyHint: '这个 key 由 sub2api 生成，复制到 SePay Webhook 的 API Key 认证配置中；SePay 回调时会带 Authorization: Apikey <this key>。',
        ...
        fxRatesTitle: '支付汇率',
        fxRatesHint: '按管理员容易理解的方式填写：1 个账本币种等于多少本地币种。',
        addFxRate: '添加汇率',
        ledgerCurrencyHint: '内部余额/记账使用的币种，通常为 USD。',
        enabledPaymentCurrencies: '由汇率生成的结账币种',
        noPaymentCurrencies: '尚未启用币种',
        fxRatesGuide: '例如 1 {ledger} = 26,000 VND 时，选择 VND 并输入 26000 或 26.000，系统会自动转换为内部 rate。',
        ...
        fxRateLedgerRequired: '请选择有效的 3 位账本币种。',
        fxRateCurrencyRequired: '请为每一行汇率选择或输入有效的 3 位支付币种。',
        fxRateCurrencyMustDiffer: '支付币种不能与账本币种相同。',
