export default {
    settings: {
      ...
      dataset: {
        title: '数据集采集',
        description: '以有界、异步方式采集请求/响应记录，用于后续微调导出。',
        enabled: '启用数据集采集',
        enabledHint: '采集采用故障开放和异步队列；关闭后只停止新采集，不改变网关请求行为。',
        credentials: 'Google Drive OAuth 凭据',
        credentialsConfigured: '凭据已配置',
        credentialsMissing: '未配置凭据',
        credentialsHint: '选择 OAuth 客户端 JSON 文件。仅在选择文件时发送，存储前会加密，且不会返回到浏览器。',
        selectedFile: '已选择：{fileName}',
        folderId: 'Google Drive 文件夹 ID',
        folderIdPlaceholder: '1AbCdEfGhIjKlMnOpQrStUvWxYz',
        folderIdHint: '请填写 Google Drive URL 中目标文件夹的 ID。',
        batchSize: '每批最大记录数',
        batchSizeHint: '准备好指定数量的记录后刷新批次。范围：1–1000。',
        batchMaxMB: '每批最大大小（MB）',
        batchMaxMBHint: 'JSONL 负载超过此大小前刷新。范围：1–100 MB。',
        batchIntervalSec: '批次间隔（秒）',
        batchIntervalHint: '打开的批次达到此间隔后刷新。范围：1–3600 秒。',
        bufferMaxItems: '最大缓冲记录数',
        bufferMaxItemsHint: '有界内存队列容量；队列满时丢弃记录，不阻塞网关请求。',
        writeOnlyNotice: '凭据仅支持写入。现有 client secret 和 refresh token 不会加载到表单，也不会由 API 返回。',
        fileTooLarge: '凭据文件必须小于 {maxKb} KiB。',
        fileEmpty: '凭据文件为空。',
        fileReadFailed: '无法读取凭据文件。',
      },
      testEmail: {
        title: '发送测试邮件',
      ...
      telegramNotifications: {
        ...
        notifyAccountErrorHint: '上游账号发生错误时发送通知',
        notifyAccountExpired: '账号已过期',
        notifyAccountExpiredHint: '账号因过期被暂停时发送通知',
        notifyPaymentSuccess: '支付成功',
        notifyPaymentSuccessHint: '支付完成时发送通知',
        notifyPaymentFailed: '支付失败',
        notifyPaymentFailedHint: '支付失败时发送通知',
        notifyRefund: '退款',
        notifyRefundHint: '发起或完成退款时发送通知',
        notifySubExpired: '订阅已过期',
        notifySubExpiredHint: '订阅过期时发送通知',
        notifyBalanceLow: '余额不足',
        notifyBalanceLowHint: '用户余额较低时发送通知',
        notifyOpsAlert: '运维告警',
        notifyOpsAlertHint: '产生运维告警时发送通知',
