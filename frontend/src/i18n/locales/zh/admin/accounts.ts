export default {
    accounts: {
      ...
      openaiProvision: {
        statusTitle: 'OpenAI 补充状态',
        loading: '正在加载 OpenAI 状态…',
        healthySummary: '健康 OpenAI：{healthy}/{target}',
        checkingSummary: '正在检查 OpenAI 账号…',
        provisioningSummary: '正在创建账号：{count} 个等待回调',
        reauthorizationSummary: '正在重新授权：{count} 个',
        healthy: '健康 OAuth',
        pending: '等待创建/回调',
        requested: '最近请求数量',
        reauthorization: '等待重新授权',
        lastCallback: '最近回调',
        nextCheck: '下次检查',
        lastCheck: '最近检查',
        reset: '重置待处理请求',
        resetting: '正在重置…',
        resetSuccess: '已重置 provisioning 状态',
        resetFailed: '重置 provisioning 状态失败',
        notAvailable: '暂无',
        noCallback: '尚未收到回调',
        received: '已收到',
        phase: {
          ...
          idle: '等待下一周期',
          checking: '正在检查账号数量',
          sending_provision_request: '正在发送创建账号请求',
          waiting_for_provision_callback: '等待 provisioning 回调',
          waiting_for_reauthorization_callback: '等待重新授权回调',
          error: '自动化出现错误',
          unknown: '未知'
        }
      },
