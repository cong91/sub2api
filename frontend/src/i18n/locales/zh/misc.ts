export default {
  ...
  payment: {
    ...
    fxRateMissing: '缺少 {currencies} 的汇率',
    fxRateStale: '{source} 汇率可能已过期',
    fxRateUpdated: '{source} 汇率，更新时间 {time}',
    ...
    paddleLoading: '正在加载 Paddle 支付...',
    paddleCheckoutReady: 'Paddle 支付已准备好。如未自动打开，请点击下方按钮。',
    paddleWaitingWebhook: '支付已提交，正在等待 Paddle 回调确认...',
    paddleLoadFailed: 'Paddle 支付加载失败，请刷新页面重试。',
    paddleNotConfigured: 'Paddle 未配置',
    hostedCheckout: {
      provider: '通过 {provider} 安全付款',
      title: '付款前请核对订单',
      orderSummary: '订单信息',
      product: '付款内容',
      amountDue: '应付金额',
      creditedBalance: '将到账余额',
      orderNo: '订单编号',
      expiresAt: '过期时间',
      openButton: '打开 Paddle 结账',
      reopenButton: '重新打开 Paddle 结账',
      secureHint: '请在 Paddle 安全结账框中输入银行卡信息并完成付款。付款后系统会自动确认订单。',
      missingOrderDetails: '订单详情不完整。您仍可打开 Paddle，但若金额不清楚，请先核对订单号或联系支持。',
      topUpProduct: '充值 V-Claw 账户余额',
      subscriptionProduct: 'V-Claw 服务订阅',
      orderTypes: {
        balance: '余额充值',
        subscription: '订阅',
      },
    ...
    admin: {
      ...
      approveRefund: '批准退款',
      retryRefund: '重试退款',
      confirmManualPayment: '确认收款',
      confirmManualPaymentPrompt: '确认订单 {order} 已收到款项（金额 {amount}）？此操作将完成订单。',
      manualPaymentConfirmed: '已确认手动收款',
      ...
      balancePackagesPageTitle: '余额套餐管理',
      balancePackagesPageDesc: '通过表单管理充值套餐，无需编辑 JSON。用户支付充值金额并获得配置的余额。',
      createBalancePackage: '创建余额套餐',
      editBalancePackage: '编辑余额套餐',
      deleteBalancePackage: '删除余额套餐',
      deleteBalancePackageConfirm: '确定要删除此余额套餐吗？',
      packageCode: '套餐代码',
      packageLabel: '套餐名称',
      packageDescription: '套餐描述',
      packageAmounts: '金额 / 余额',
      amountLedger: '支付金额',
      creditLedger: '到账余额',
      bonusLedger: '赠送余额',
      creditMultiplier: '余额倍数',
      balanceGroup: '余额分组',
      selectBalanceGroup: '选择标准余额分组',
      balanceGroupHelp: '仅允许选择启用的 standard 分组。订阅分组必须用于订阅套餐，不能用于余额充值包。',
      balanceGroupRequired: '请选择余额分组',
      balanceGroupMissing: '缺少余额分组',
      payAmount: '支付',
      creditAmount: '到账',
      badge: '标签',
      popular: '热门',
      balancePackageFormula: '公式：用户支付“支付金额”，系统增加“到账余额”。倍数 = 到账 / 支付，赠送 = 到账 - 支付。',
      packageRequired: '套餐代码和名称为必填项',
      packageAmountRequired: '支付金额和到账余额必须大于 0',
      originalPrice: '原价',
      price: '价格',
