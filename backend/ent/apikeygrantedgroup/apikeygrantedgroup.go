...
const (
	// Label holds the string label denoting the apikeygrantedgroup type in the database.
	Label = "api_key_granted_group"
	...
	GroupFieldID = "id"
	// Table holds the table name of the apikeygrantedgroup in the database.
...
// Columns holds all SQL columns for apikeygrantedgroup fields.
var Columns = []string{
	FieldAPIKeyID,
	FieldGroupID,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the APIKeyGrantedGroup queries.
