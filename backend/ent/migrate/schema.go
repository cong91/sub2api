...
var (
	...
	BalancePackagesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BalancePackagesColumns[7]},
			},
			{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "fx_rate_payment_to_ledger", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "fx_source", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "fx_timestamp", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "concurrency", Type: field.TypeInt, Default: 50},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
