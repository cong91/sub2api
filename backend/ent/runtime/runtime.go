...
func init() {
	...
	balancepackageDescActualCredits := balancepackageFields[4].Descriptor()
	...
	balancepackageDescCreditUnit := balancepackageFields[5].Descriptor()
	...
	groupDescPricingReferenceModel := groupFields[53].Descriptor()
	...
	userDescBalanceNotifyTelegramChatID := userFields[19].Descriptor()
