...
const (
	...
	// Node types.
	TypeAPIKey                  = "APIKey"
	TypeAPIKeyGrantedGroup      = "APIKeyGrantedGroup"
	TypeAccount                 = "Account"
...
type APIKeyMutation struct {
	...
	group                 *int64
	clearedgroup          bool
	granted_groups        map[int64]struct{}
	removedgranted_groups map[int64]struct{}
	clearedgranted_groups bool
...
func (m *APIKeyMutation) AddGrantedGroupIDs(ids ...int64) {
	if m.granted_groups == nil {
		m.granted_groups = make(map[int64]struct{})
	}
	for i := range ids {
		m.granted_groups[ids[i]] = struct{}{}
	}
}

// ClearGrantedGroups clears the "granted_groups" edge to the Group entity.
func (m *APIKeyMutation) ClearGrantedGroups() {
	m.clearedgranted_groups = true
}

// GrantedGroupsCleared reports if the "granted_groups" edge to the Group entity was cleared.
func (m *APIKeyMutation) GrantedGroupsCleared() bool {
	return m.clearedgranted_groups
}

// RemoveGrantedGroupIDs removes the "granted_groups" edge to the Group entity by IDs.
func (m *APIKeyMutation) RemoveGrantedGroupIDs(ids ...int64) {
	if m.removedgranted_groups == nil {
		m.removedgranted_groups = make(map[int64]struct{})
	}
	for i := range ids {
		delete(m.granted_groups, ids[i])
		m.removedgranted_groups[ids[i]] = struct{}{}
	}
}

// RemovedGrantedGroups returns the removed IDs of the "granted_groups" edge to the Group entity.
func (m *APIKeyMutation) RemovedGrantedGroupsIDs() (ids []int64) {
	for id := range m.removedgranted_groups {
		ids = append(ids, id)
	}
	return
}

// GrantedGroupsIDs returns the "granted_groups" edge IDs in the mutation.
func (m *APIKeyMutation) GrantedGroupsIDs() (ids []int64) {
	for id := range m.granted_groups {
		ids = append(ids, id)
	}
	return
}

// ResetGrantedGroups resets all changes to the "granted_groups" edge.
func (m *APIKeyMutation) ResetGrantedGroups() {
	m.granted_groups = nil
	m.clearedgranted_groups = false
	m.removedgranted_groups = nil
}
...
func (m *APIKeyMutation) AddedEdges() []string {
	...
	if m.granted_groups != nil {
		edges = append(edges, apikey.EdgeGrantedGroups)
	}
	if m.usage_logs != nil {
...
func (m *APIKeyMutation) AddedIDs(name string) []ent.Value {
	...
	case apikey.EdgeGrantedGroups:
		ids := make([]ent.Value, 0, len(m.granted_groups))
		for id := range m.granted_groups {
			ids = append(ids, id)
		}
		return ids
...
func (m *APIKeyMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case apikey.EdgeGrantedGroups:
		ids := make([]ent.Value, 0, len(m.removedgranted_groups))
		for id := range m.removedgranted_groups {
			ids = append(ids, id)
		}
		return ids
...
// APIKeyGrantedGroupMutation represents an operation that mutates the APIKeyGrantedGroup nodes in the graph.
type APIKeyGrantedGroupMutation struct {
	config
	op             Op
	typ            string
	created_at     *time.Time
	...
	oldValue       func(context.Context) (*APIKeyGrantedGroup, error)
	predicates     []predicate.APIKeyGrantedGroup
}

var _ ent.Mutation = (*APIKeyGrantedGroupMutation)(nil)

// apikeygrantedgroupOption allows management of the mutation configuration using functional options.
type apikeygrantedgroupOption func(*APIKeyGrantedGroupMutation)

// newAPIKeyGrantedGroupMutation creates new mutation for the APIKeyGrantedGroup entity.
func newAPIKeyGrantedGroupMutation(c config, op Op, opts ...apikeygrantedgroupOption) *APIKeyGrantedGroupMutation {
	m := &APIKeyGrantedGroupMutation{
		config:        c,
		op:            op,
		typ:           TypeAPIKeyGrantedGroup,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m APIKeyGrantedGroupMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m APIKeyGrantedGroupMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
func (m *APIKeyGrantedGroupMutation) SetAPIKeyID(i int64) {
	m.api_key = &i
}

// APIKeyID returns the value of the "api_key_id" field in the mutation.
func (m *APIKeyGrantedGroupMutation) APIKeyID() (r int64, exists bool) {
	v := m.api_key
	if v == nil {
		return
	}
...
func (m *APIKeyGrantedGroupMutation) ResetAPIKeyID() {
	m.api_key = nil
}

// SetGroupID sets the "group_id" field.
func (m *APIKeyGrantedGroupMutation) SetGroupID(i int64) {
	m.group = &i
}

// GroupID returns the value of the "group_id" field in the mutation.
func (m *APIKeyGrantedGroupMutation) GroupID() (r int64, exists bool) {
	v := m.group
	if v == nil {
		return
	}
...
// ResetGroupID resets all changes to the "group_id" field.
func (m *APIKeyGrantedGroupMutation) ResetGroupID() {
	m.group = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *APIKeyGrantedGroupMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *APIKeyGrantedGroupMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *APIKeyGrantedGroupMutation) ResetCreatedAt() {
	m.created_at = nil
}

// ClearAPIKey clears the "api_key" edge to the APIKey entity.
func (m *APIKeyGrantedGroupMutation) ClearAPIKey() {
	m.clearedapi_key = true
	m.clearedFields[apikeygrantedgroup.FieldAPIKeyID] = struct{}{}
}

// APIKeyCleared reports if the "api_key" edge to the APIKey entity was cleared.
func (m *APIKeyGrantedGroupMutation) APIKeyCleared() bool {
...
func (m *APIKeyGrantedGroupMutation) APIKeyIDs() (ids []int64) {
...
func (m *APIKeyGrantedGroupMutation) ResetAPIKey() {
	m.api_key = nil
	m.clearedapi_key = false
}

// ClearGroup clears the "group" edge to the Group entity.
func (m *APIKeyGrantedGroupMutation) ClearGroup() {
	m.clearedgroup = true
	m.clearedFields[apikeygrantedgroup.FieldGroupID] = struct{}{}
}

// GroupCleared reports if the "group" edge to the Group entity was cleared.
func (m *APIKeyGrantedGroupMutation) GroupCleared() bool {
	return m.clearedgroup
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// GroupID instead. It exists only for internal usage by the builders.
func (m *APIKeyGrantedGroupMutation) GroupIDs() (ids []int64) {
	if id := m.group; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetGroup resets all changes to the "group" edge.
func (m *APIKeyGrantedGroupMutation) ResetGroup() {
	m.group = nil
	m.clearedgroup = false
}

// Where appends a list predicates to the APIKeyGrantedGroupMutation builder.
func (m *APIKeyGrantedGroupMutation) Where(ps ...predicate.APIKeyGrantedGroup) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the APIKeyGrantedGroupMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *APIKeyGrantedGroupMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.APIKeyGrantedGroup, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *APIKeyGrantedGroupMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *APIKeyGrantedGroupMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (APIKeyGrantedGroup).
func (m *APIKeyGrantedGroupMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *APIKeyGrantedGroupMutation) Fields() []string {
	fields := make([]string, 0, 3)
	if m.api_key != nil {
		fields = append(fields, apikeygrantedgroup.FieldAPIKeyID)
	}
	if m.group != nil {
		fields = append(fields, apikeygrantedgroup.FieldGroupID)
	}
	if m.created_at != nil {
		fields = append(fields, apikeygrantedgroup.FieldCreatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *APIKeyGrantedGroupMutation) Field(name string) (ent.Value, bool) {
	switch name {
	case apikeygrantedgroup.FieldAPIKeyID:
		return m.APIKeyID()
	case apikeygrantedgroup.FieldGroupID:
		return m.GroupID()
	case apikeygrantedgroup.FieldCreatedAt:
		return m.CreatedAt()
	}
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *APIKeyGrantedGroupMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	return nil, errors.New("edge schema APIKeyGrantedGroup does not support getting old values")
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *APIKeyGrantedGroupMutation) SetField(name string, value ent.Value) error {
	switch name {
	case apikeygrantedgroup.FieldAPIKeyID:
		v, ok := value.(int64)
		if !ok {
	...
	return fmt.Errorf("unknown APIKeyGrantedGroup field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *APIKeyGrantedGroupMutation) AddedFields() []string {
	var fields []string
	return fields
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *APIKeyGrantedGroupMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *APIKeyGrantedGroupMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown APIKeyGrantedGroup numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *APIKeyGrantedGroupMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *APIKeyGrantedGroupMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *APIKeyGrantedGroupMutation) ClearField(name string) error {
	return fmt.Errorf("unknown APIKeyGrantedGroup nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *APIKeyGrantedGroupMutation) ResetField(name string) error {
	switch name {
	case apikeygrantedgroup.FieldAPIKeyID:
		m.ResetAPIKeyID()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *APIKeyGrantedGroupMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.api_key != nil {
		edges = append(edges, apikeygrantedgroup.EdgeAPIKey)
	}
	if m.group != nil {
		edges = append(edges, apikeygrantedgroup.EdgeGroup)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *APIKeyGrantedGroupMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case apikeygrantedgroup.EdgeAPIKey:
		if id := m.api_key; id != nil {
			return []ent.Value{*id}
		}
	case apikeygrantedgroup.EdgeGroup:
		if id := m.group; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *APIKeyGrantedGroupMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *APIKeyGrantedGroupMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *APIKeyGrantedGroupMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedapi_key {
		edges = append(edges, apikeygrantedgroup.EdgeAPIKey)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *APIKeyGrantedGroupMutation) EdgeCleared(name string) bool {
	switch name {
	case apikeygrantedgroup.EdgeAPIKey:
		return m.clearedapi_key
	case apikeygrantedgroup.EdgeGroup:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *APIKeyGrantedGroupMutation) ClearEdge(name string) error {
	switch name {
	case apikeygrantedgroup.EdgeAPIKey:
		m.ClearAPIKey()
		return nil
	...
	return fmt.Errorf("unknown APIKeyGrantedGroup unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *APIKeyGrantedGroupMutation) ResetEdge(name string) error {
	switch name {
	case apikeygrantedgroup.EdgeAPIKey:
		m.ResetAPIKey()
		return nil
	...
	return fmt.Errorf("unknown APIKeyGrantedGroup edge %s", name)
}
...
type GroupMutation struct {
	...
	granted_api_keys                        map[int64]struct{}
	removedgranted_api_keys                 map[int64]struct{}
	clearedgranted_api_keys                 bool
...
func (m *GroupMutation) AddGrantedAPIKeyIDs(ids ...int64) {
	if m.granted_api_keys == nil {
		m.granted_api_keys = make(map[int64]struct{})
	}
	for i := range ids {
		m.granted_api_keys[ids[i]] = struct{}{}
	}
}

// ClearGrantedAPIKeys clears the "granted_api_keys" edge to the APIKey entity.
func (m *GroupMutation) ClearGrantedAPIKeys() {
	m.clearedgranted_api_keys = true
}

// GrantedAPIKeysCleared reports if the "granted_api_keys" edge to the APIKey entity was cleared.
func (m *GroupMutation) GrantedAPIKeysCleared() bool {
	return m.clearedgranted_api_keys
}

// RemoveGrantedAPIKeyIDs removes the "granted_api_keys" edge to the APIKey entity by IDs.
func (m *GroupMutation) RemoveGrantedAPIKeyIDs(ids ...int64) {
	if m.removedgranted_api_keys == nil {
		m.removedgranted_api_keys = make(map[int64]struct{})
	}
	for i := range ids {
		delete(m.granted_api_keys, ids[i])
		m.removedgranted_api_keys[ids[i]] = struct{}{}
	}
}

// RemovedGrantedAPIKeys returns the removed IDs of the "granted_api_keys" edge to the APIKey entity.
func (m *GroupMutation) RemovedGrantedAPIKeysIDs() (ids []int64) {
	for id := range m.removedgranted_api_keys {
		ids = append(ids, id)
	}
	return
}

// GrantedAPIKeysIDs returns the "granted_api_keys" edge IDs in the mutation.
func (m *GroupMutation) GrantedAPIKeysIDs() (ids []int64) {
	for id := range m.granted_api_keys {
		ids = append(ids, id)
	}
	return
}

// ResetGrantedAPIKeys resets all changes to the "granted_api_keys" edge.
func (m *GroupMutation) ResetGrantedAPIKeys() {
	m.granted_api_keys = nil
	m.clearedgranted_api_keys = false
	m.removedgranted_api_keys = nil
}
...
func (m *GroupMutation) AddedEdges() []string {
	...
	if m.granted_api_keys != nil {
		edges = append(edges, group.EdgeGrantedAPIKeys)
	}
	if m.redeem_codes != nil {
...
func (m *GroupMutation) AddedIDs(name string) []ent.Value {
	...
	case group.EdgeAPIKeys:
		...
		return ids
	case group.EdgeGrantedAPIKeys:
		ids := make([]ent.Value, 0, len(m.granted_api_keys))
		for id := range m.granted_api_keys {
			ids = append(ids, id)
		}
		return ids
...
func (m *GroupMutation) RemovedIDs(name string) []ent.Value {
	...
	case group.EdgeAPIKeys:
		...
		return ids
	case group.EdgeGrantedAPIKeys:
		ids := make([]ent.Value, 0, len(m.removedgranted_api_keys))
		for id := range m.removedgranted_api_keys {
			ids = append(ids, id)
		}
		return ids
