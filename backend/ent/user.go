...
type UserEdges struct {
	...
	// CreatedPromoCodes holds the value of the created_promo_codes edge.
	CreatedPromoCodes []*PromoCode `json:"created_promo_codes,omitempty"`
...
// CreatedPromoCodesOrErr returns the CreatedPromoCodes value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) CreatedPromoCodesOrErr() ([]*PromoCode, error) {
	if e.loadedTypes[3] {
		return e.CreatedPromoCodes, nil
	}
	return nil, &NotLoadedError{edge: "created_promo_codes"}
}
...
// QueryCreatedPromoCodes queries the "created_promo_codes" edge of the User entity.
func (_m *User) QueryCreatedPromoCodes() *PromoCodeQuery {
	return NewUserClient(_m.config).QueryCreatedPromoCodes(_m)
}
