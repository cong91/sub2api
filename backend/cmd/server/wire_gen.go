...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIAutoProvisionService := service.ProvideOpenAIAutoProvisionService(accountRepository, adminService, settingService, settingRepository, openAIOAuthService, leaderLockCache, db, tokenRefreshService)
