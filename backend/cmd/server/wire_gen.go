...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	inviteBootstrapAPIKeyService := service.ProvideInviteBootstrapAPIKeyService(apiKeyService)
	telegramNotifyService := service.NewTelegramNotifyService(settingRepository)
	authService := service.ProvideAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, tencentCaptchaService, aliyunCaptchaService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, userDeviceRepository, inviteBootstrapAPIKeyService, groupRepository, telegramNotifyService)
	...
	canvasLaunchStore := repository.NewCanvasLaunchStore(redisClient)
	authHandler := handler.ProvideAuthHandler(configConfig, authService, userService, settingService, promoService, redeemService, totpService, userAttributeService, canvasLaunchStore)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, pluginManager, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, openAIProvisionDemandService, configConfig, coordinator)
