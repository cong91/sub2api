...
type UserSubscriptionRepository interface {
	...
	List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, status, platform, deviceCode, sortBy, sortOrder string) ([]UserSubscription, *pagination.PaginationResult, error)
