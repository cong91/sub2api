...
const (
	...
	SettingKeyOpenAIAutoProvisionRequestsPerAccount = "openai_auto_provision_requests_per_account"
	SettingKeyOpenAIAutoProvisionTokensPerAccount   = "openai_auto_provision_tokens_per_account"
