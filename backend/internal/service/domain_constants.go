...
const (
	...
	RoleMarketing = domain.RoleMarketing
...
const (
	...
	SettingKeyDeviceAutoActivationAffCodes     = "device_auto_activation_aff_codes"    // 设备 claim 自动激活的推广码列表（逗号分隔）
	...
	SettingKeyDeviceClaimBonusBalance = "device_claim_bonus_balance" // 新设备首次认领奖励余额
