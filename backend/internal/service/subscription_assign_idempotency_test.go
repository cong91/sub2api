...
func (userSubRepoNoop) List(context.Context, pagination.PaginationParams, *int64, *int64, []int64, string, string, string, string, string) ([]UserSubscription, *pagination.PaginationResult, error) {
	panic("unexpected List call")
}
