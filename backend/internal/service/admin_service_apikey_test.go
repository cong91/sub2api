...
func TestAdminService_AdminUpdateAPIKeyGroupID_KeyNotFound(t *testing.T) {
	...
	_, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 999, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(1)})
...
func TestAdminService_AdminUpdateAPIKeyGroupID_NilGroupID_NoOp(t *testing.T) {
	...
	got, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{})
...
func TestAdminService_AdminUpdateAPIKeyGroupID_Unbind(t *testing.T) {
	...
	got, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(0)})
	require.NoError(t, err)
...
func TestAdminService_AdminUpdateAPIKeyGroupID_BindActiveGroup(t *testing.T) {
	...
	got, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(10)})
	require.NoError(t, err)
...
func TestAdminService_AdminUpdateAPIKeyGroupID_GroupNotFound(t *testing.T) {
	...
	_, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(99)})
...
func TestAdminService_AdminUpdateAPIKeyGroupID_GroupNotActive(t *testing.T) {
	...
	_, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(5)})
	require.Error(t, err)
...
func TestAdminService_AdminUpdateAPIKeyGroupID_UpdateFails(t *testing.T) {
	...
	_, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(0)})
	require.Error(t, err)
...
func TestAdminService_AdminUpdateAPIKeyGroupID_PointerIsolation(t *testing.T) {
	...
	inputGID := int64(10)
	got, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: &inputGID})
	require.NoError(t, err)
	require.NotNil(t, got.APIKey.GroupID)
...
func TestAdminService_AdminUpdateAPIKeyGroupID_NilCacheInvalidator(t *testing.T) {
	...
	got, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(7)})
	require.NoError(t, err)
	require.NotNil(t, got.APIKey.GroupID)
...
func TestAdminService_AdminUpdateAPIKeyGroupID_SubscriptionGroup_Blocked(t *testing.T) {
	...
	// 无有效订阅时应拒绝绑定
	_, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{GroupID: int64Ptr(10)})
	require.Error(t, err)
...
func TestAdminService_AdminUpdateAPIKeyGroupID_WithGrantedGroupsAndDefault(t *testing.T) {
	existing := &APIKey{ID: 1, UserID: 42, Key: "sk-test", GroupID: int64Ptr(2)}
	apiKeyRepo := &apiKeyRepoStubForGroupUpdate{key: existing}
	groupRepo := &groupRepoStubForGroupUpdate{
		groups: map[int64]*Group{
			2: &Group{ID: 2, Name: "OpenAI", Status: StatusActive, Platform: PlatformOpenAI},
			3: &Group{ID: 3, Name: "Antigravity", Status: StatusActive, Platform: PlatformAntigravity},
		},
	}
	cache := &authCacheInvalidatorStub{}
	svc := &adminServiceImpl{apiKeyRepo: apiKeyRepo, groupRepo: groupRepo, authCacheInvalidator: cache}
	...
	got, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{
		GrantedGroupIDs: &granted,
		DefaultGroupID:  int64Ptr(2),
	})
	require.NoError(t, err)
	require.NotNil(t, got.APIKey.GroupID)
	require.Equal(t, int64(2), *got.APIKey.GroupID)
	require.Len(t, got.APIKey.GrantedGroups, 2)
	require.Equal(t, int64(2), got.APIKey.GrantedGroups[0].ID)
	require.Equal(t, int64(3), got.APIKey.GrantedGroups[1].ID)
	require.NotNil(t, apiKeyRepo.updated)
	require.Len(t, apiKeyRepo.updated.GrantedGroups, 2)
	require.Equal(t, []string{"sk-test"}, cache.keys)
}

func TestAdminService_AdminUpdateAPIKeyGroupID_GroupIDMismatchDefaultGroupID(t *testing.T) {
	existing := &APIKey{ID: 1, Key: "sk-test"}
	apiKeyRepo := &apiKeyRepoStubForGroupUpdate{key: existing}
	svc := &adminServiceImpl{apiKeyRepo: apiKeyRepo}

	_, err := svc.AdminUpdateAPIKeyGroupID(context.Background(), 1, AdminUpdateAPIKeyGroupUpdateInput{
		GroupID:        int64Ptr(2),
		DefaultGroupID: int64Ptr(3),
	})
	require.Error(t, err)
	require.Equal(t, "GROUP_ID_MISMATCH", infraerrors.Reason(err))
}

func TestAdminService_AdminUpdateAPIKeyGroupID_GrantedGroupsWithDefaultZero(t *testing.T) {
	existing := &APIKey{ID: 1, Key: "sk-test"}
	apiKeyRepo := &apiKeyRepoStubForGroupUpdate{key: existing}
	svc := &adminServiceImpl{apiKeyRepo: apiKeyRepo}
	granted := []int64{2, 3}
