...
func TestVClawClaimServiceResumesUsedClaimCodeByBinding(t *testing.T) {
	...
	require.Equal(t, UserDeviceStatusActive, result.Status)
...
func TestVClawClaimServiceFirstClaimAssignsDefaultSubscriptionOnce(t *testing.T) {
	...
	require.Equal(t, UserDeviceStatusActive, first.Status)
	...
	require.Equal(t, UserDeviceStatusActive, resume.Status)
