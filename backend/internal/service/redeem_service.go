...
type RedeemCodeRepository interface {
	...
	ListWithFilters(ctx context.Context, params pagination.PaginationParams, codeType, status, search string, createdBy *int64) ([]RedeemCode, *pagination.PaginationResult, error)
