...
## 3. Account and API Key Security
...
## 4. Usage Credits, Rates, and Billing
...
V-Claw may update supported models, routes, pricing, package rules, or rate multipliers from time to time due to upstream provider changes, infrastructure cost changes, risk-control requirements, or operational requirements. Where practical, material changes will be reflected in the platform or announced through the official support channel.

## 5. Upstream Provider Dependency
...
## 3. Bảo mật tài khoản và API key
...
## 4. Credit sử dụng, mức giá và tính phí
...
## 5. Phụ thuộc nhà cung cấp thượng nguồn
...
V-Claw có thể tạm dừng, hạn chế, xoay/đổi key hoặc chấm dứt quyền truy cập nếu có cơ sở hợp lý cho rằng người dùng vi phạm Điều khoản, lạm dụng Dịch vụ hoặc tạo rủi ro cho nền tảng, nhà cung cấp thượng nguồn hoặc người dùng khác.

## 7. Hoàn tiền và điều chỉnh số dư
...
## 9. Độ sẵn sàng và bảo trì Dịch vụ
...
- 불법, 유해, 남용, 침해, 기만 또는 착취적 콘텐츠의 생성, 요청, 배포 또는 조력;
