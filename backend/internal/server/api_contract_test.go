		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"auth_source_default_email_concurrency": 50,
					"auth_source_default_email_subscriptions": [],
					"auth_source_default_email_grant_on_signup": false,
					"auth_source_default_email_grant_on_first_bind": false,
					"auth_source_default_github_balance": 0,
					"auth_source_default_github_concurrency": 50,
					...
					"auth_source_default_google_concurrency": 50,
					...
					"auth_source_default_wechat_concurrency": 50,
					"auth_source_default_wechat_subscriptions": [],
					"auth_source_default_wechat_grant_on_signup": false,
					"auth_source_default_wechat_grant_on_first_bind": false,
					"auth_source_default_dingtalk_balance": 0,
					"auth_source_default_dingtalk_concurrency": 50,
...
func (stubRedeemCodeRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, codeType, status, search string, createdBy *int64) ([]service.RedeemCode, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
