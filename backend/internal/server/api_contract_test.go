		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyDatasetEnabled:                "true",
					service.SettingKeyDatasetBatchSize:              "100",
					service.SettingKeyDatasetBatchMaxMB:             "10",
					service.SettingKeyDatasetBatchIntervalSec:       "30",
					service.SettingKeyDatasetBufferMaxItems:         "1000",
					service.SettingKeyDatasetGoogleDriveFolderID:    "test-folder-abc123",
					service.SettingKeyDatasetGoogleDriveCredentials: "encrypted-test-cred",
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyDatasetEnabled:                "false",
					service.SettingKeyDatasetBatchSize:              "0",
					service.SettingKeyDatasetBatchMaxMB:             "0",
					service.SettingKeyDatasetBatchIntervalSec:       "0",
					service.SettingKeyDatasetBufferMaxItems:         "0",
					service.SettingKeyDatasetGoogleDriveFolderID:    "",
					service.SettingKeyDatasetGoogleDriveCredentials: "",
				})
			},
			method:     http.MethodGet,
			path:       "/api/v1/admin/settings",
			...
			wantJSON: `{
				...
				"data": {
					...
					"cyber_session_block_enabled": false,
					"cyber_session_block_ttl_seconds": 3600,
					"dataset_batch_interval_sec": 0,
					"dataset_batch_max_mb": 0,
					"dataset_batch_size": 0,
					"dataset_buffer_max_items": 0,
...
func (stubUserSubscriptionRepo) List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, scopedUserIDs []int64, status, platform, deviceCode, sortBy, sortOrder string) ([]service.UserSubscription, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
