...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		DatasetGoogleDriveCredentialsConfigured:                settings.DatasetGoogleDriveCredentialsConfigured,
		DatasetGoogleDriveFolderID:                             settings.DatasetGoogleDriveFolderID,
		DatasetBatchSize:                                       settings.DatasetBatchSize,
		DatasetBatchMaxMB:                                      settings.DatasetBatchMaxMB,
		DatasetBatchIntervalSec:                                settings.DatasetBatchIntervalSec,
		DatasetBufferMaxItems:                                  settings.DatasetBufferMaxItems,
		...
		OpenAIAutoProvisionEnabled:                             settings.OpenAIAutoProvisionEnabled,
		OpenAIAutoProvisionTarget:                              settings.OpenAIAutoProvisionTarget,
		OpenAIAutoProvisionIntervalSeconds:                     settings.OpenAIAutoProvisionIntervalSeconds,
		OpenAIAutoProvisionTurbURL:                             settings.OpenAIAutoProvisionTurbURL,
		OpenAIAutoProvisionTurbAuthCodeConfigured:              settings.OpenAIAutoProvisionTurbAuthCodeConfigured,
		OpenAIAutoProvisionCallbackURL:                         settings.OpenAIAutoProvisionCallbackURL,
